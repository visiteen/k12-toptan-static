(function(){
  ...
  function addStyle(){
    ...
    s.textContent='.k12-yetkinlik-family{margin-top:58px}.k12-yetkinlik-family .catalog-family-head{border-top:3px solid #C2410C;padding-top:24px}.k12-yetkinlik-family .catalog-family-head span{color:#C2410C}.k12-yetkinlik-card{position:relative;overflow:hidden}.k12-yetkinlik-card:before{content:"";position:absolute;left:0;top:0;bottom:0;width:4px;background:#C2410C}.k12-yetkinlik-card .catalog-top span{color:#C2410C}.k12-yetkinlik-card .mini-list{margin-top:18px;padding-top:15px;border-top:1px solid var(--line);display:flex;gap:7px;flex-wrap:wrap}.k12-yetkinlik-card .mini-list em{font-style:normal;font-size:10px;font-weight:800;color:#9A3412;background:#FFF1E8;border:1px solid #FED7AA;border-radius:999px;padding:6px 8px}.k12-yetkinlik-detail{background:linear-gradient(135deg,#FFF7ED,#fff);border-top:1px solid #FFEDD5;border-bottom:1px solid #FFEDD5}.k12-yetkinlik-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:16px}.k12-yetkinlik-box{background:#fff;border:1px solid var(--line);border-radius:18px;padding:26px;min-height:310px}.k12-yetkinlik-box .num{font-size:11px;color:#C2410C;font-weight:800;letter-spacing:.08em}.k12-yetkinlik-box h3{margin:16px 0 8px;color:var(--deep)}.k12-yetkinlik-box>p{font-size:12px;color:var(--muted);min-height:42px}.k12-yetkinlik-items{margin-top:20px;display:grid;gap:9px}.k12-yetkinlik-item{padding:10px 12px;border-radius:10px;background:#FFFBF7;border:1px solid #FFE7D1;font-size:12px;color:var(--slate)}.k12-yetkinlik-item strong{display:block;color:var(--deep);font-size:12px}.k12-yetkinlik-item small{display:block;color:var(--muted);margin-top:2px}.k12-global-proof{display:flex;gap:7px;flex-wrap:wrap;margin-top:10px}.k12-global-proof span{font-size:9px;font-weight:800;border-radius:999px;padding:5px 7px;background:#FFF1E8;color:#9A3412}.mega .k12-future-link strong{color:#9A3412}@media(min-width:1051px){.mega-grid.k12-six-col{grid-template-columns:repeat(5,1fr) 1.1fr;gap:20px}}@media(max-width:850px){.k12-yetkinlik-grid{grid-template-columns:1fr}}';
